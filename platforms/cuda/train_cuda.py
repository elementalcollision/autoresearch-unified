...
EMBEDDING_LR = 0.4      # decreased learning rate for token embeddings (Adam)
UNEMBEDDING_LR = 0.004  # learning rate for lm_head (Adam)
MATRIX_LR = 0.02        # decreased learning rate for matrix parameters (Muon) (was 0.03)
SCALAR_LR = 0.5         # learning rate for per-layer scalars (Adam)
WEIGHT_DECAY = 0.15     # decreased weight decay for Muon
ADAM_BETAS = (0.8, 0.95) # Adam beta1, beta2
WARMUP_RATIO = 0.05     # fraction of time budget for LR warmup (was 0.0)
WARMDOWN_RATIO = 0.85   # fraction of time budget for LR warmdown (increased from 0.7)
FINAL_LR_FRAC = 0.01    # final LR as fraction of initial (was 0.0)
