...
MLP_RATIO = 8.0        # increase capacity of MLP layers

# Optimization
TOTAL_BATCH_SIZE = _hp_defaults['total_batch_size']
EMBEDDING_LR = 1.0      # learning rate for token embeddings (Adam)
UNEMBEDDING_LR = 0.004  # learning rate for lm_head (Adam)
MATRIX_LR = 0.02005     # learning rate for matrix parameters (Muon)
SCALAR_LR = 3.0         # learning rate for per-layer scalars (Adam)
