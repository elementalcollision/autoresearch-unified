...
WARMDOWN_RATIO = 0.7    # fraction of time budget for LR warmdown (increased from 0.5)
...
DEVICE_BATCH_SIZE = max(1, _hp_defaults['device_batch_size'] - 1)  # decrease by 1 step
