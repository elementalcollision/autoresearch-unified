...
# Model architecture
ASPECT_RATIO = 56       # model_dim = depth * ASPECT_RATIO (decreased from 64)
HEAD_DIM = 128          # target head dimension for attention
WINDOW_PATTERN = "SSSL" # sliding window pattern: L=full, S=half context

# Optimization
TOTAL_BATCH_SIZE = _hp_defaults['total_batch_size']
EMBEDDING_LR = 1.2      # learning rate for token embeddings (Adam) (increased from 0.6)
UNEMBEDDING_LR = 0.004  # learning rate for lm_head (Adam)
MATRIX_LR = 0.04        # learning rate for matrix parameters (Muon)
SCALAR_LR = 0.5         # learning rate for per-layer scalars (Adam)
WEIGHT_DECAY = 0.15     # cautious weight decay for Muon (decreased from 0.2)
ADAM_BETAS = (0.8, 0.95) # Adam beta1, beta2
WARMUP_RATIO = 0.05     # fraction of time budget for LR warmup (was 0.0)
WARMDOWN_RATIO = 0.98   # fraction of time budget for LR warmdown (increased from 0.95)
