...
EMBEDDING_LR = 0.305    # learning rate for token embeddings (Adam), decreased from 0.32
UNEMBEDDING_LR = 0.004  # learning rate for lm_head (Adam)
MATRIX_LR = 0.028       # learning rate for matrix parameters (Muon), decreased from 0.03
SCALAR_LR = 0.32        # learning rate for per-layer scalars (Adam)
WEIGHT_DECAY = 0.043    # slightly decreased weight decay for Muon
