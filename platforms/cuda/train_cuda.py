...
# Optimization
TOTAL_BATCH_SIZE = int(_hp_defaults['total_batch_size'] * 1.05)
EMBEDDING_LR = 0.19     # learning rate for token embeddings (Adam) (increased)
...
WEIGHT_DECAY = 0.075    # lowered weight decay for Muon (changed)
