"""
MuonAdamW optimizer for ROCm backend.
Ported from muon_cuda.py for AMD Instinct GPUs:
...
class MuonAdamW(torch.optim.Optimizer):
    ...
    ROCm-optimized with torch.compile (AMD Triton) and device-local scalar tensors."""
